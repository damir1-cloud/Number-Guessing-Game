...
do {
  ...
  let roundCheck: Type = await inquirer.prompt({
    name: "rounds",
    type: "number",
  ...
  do {
    ...
    let answer: Type = await inquirer.prompt({
      name: "userGuess",
      type: "number",
    ...
    console.log(
      `Computer generated number is: ${computerGeneratedNumber}, and your guessed number is: ${userGuess}`
    );
